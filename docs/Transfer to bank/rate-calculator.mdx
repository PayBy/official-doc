...
=======
    The withdrawal fee incurred from the payout is deducted externally and is not included in the order amount.
>>>>>>> master
...
<<<<<<< patch-5
    ...
    *rate = fundOutAmount / orderAmount*
    ...
    Example value: 1.96
=======
    The exchange rate that AED to the currency of the received fund, rounded to 2 decimal places: 
...
| 0        | SUCCESS                      | Success                                                     | —                                 |
| 400      | INVALID_PARAMETER            | Invalid parameters                                          | Adjust the request parameters     |
| 400      | REQUESTTIME_TOO_EARLY       | Request time is too far ahead of the current time           | Adjust the request time           |
| 400      | REQUESTTIME_TOO_LATER       | Request time is too far behind the current time             | Adjust the request time           |
