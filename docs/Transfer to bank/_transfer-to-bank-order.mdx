...
- **Example**: `-`  
- **Description**: Detailed information about the payment processing, especially related to fees and timing

`TransferToBankPaymentInfo`

| Field Name         | Variable Name     | Required | Type           | Example | Description                      |
|--------------------|-------------------|----------|----------------|---------|----------------------------------|
| Payer Fee Amount   | payerFeeAmount    | Optional | Money          | -       | The fee charged to the sender (payer), including amount and currency.                                 |
| Estimated Arrival Time | arrivalTime    | Optional | Timestamp(3)   |         | Timestamp when the funds were expected to arrive or did arrive.  |
