...
- **product** <font color = ' #7d8793'>String</font>
	...
	The type of financial service or transaction being used.
...
- **status** <font color = ' #7d8793'>String</font>
	...
	The current state of the transaction. Common statuses include:
	- "CREATED" – The transfer order has been created.
	- "COMPLETED" – The transfer completes.
...
- **paymentInfo** <font color = ' #7d8793'>Object</font>
	...
	A nested object that contains detailed information about the payment, such as: amount, currency, arrivalTime.
