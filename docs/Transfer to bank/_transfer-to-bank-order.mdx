...
- **holderName** <font color = ' #7d8793'>String</font> <font color = '#f19938'>Required</font>
	...
	The hloder name of the beneficiary account. The parameter needs to be encrypted when passed, and RSA algorithm is recommended.
...
- **iban** <font color = ' #7d8793'>String</font>
	...
	The IBAN number of the beneficiary account. The parameter needs to be encrypted when passed, and RSA algorithm is recommended.
...
- **beneficiaryAddress** <font color = ' #7d8793'>String</font> <font color = '#f19938'>Required</font>
  ...
  3. The parameter needs to be encrypted when passed, and RSA algorithm is recommended.
