...
- **Content-Language**  
   - **Variable Name**: `Content-Language`  
   - **Required**: Optional  
   - **Type**: `String(10)`  
   - **Example**: `en`  
...
- **Type**: `ResponseHeader`  
- **Example**: `-`  
- **Description**: Contains response status and error information
...
- **Content Disposition**  
   - **Variable Name**: `Content-Disposition`  
   - **Required**: Required  
   - **Type**: `String`  
   - **Example**: `attachment; filename=200000054800_20210112Transaction_Settle_Statement.zip`  
...
- **Content Type**  
   ...
   - **Description**: MIME type indicating ZIP file format
