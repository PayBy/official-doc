...
- **sharingParamList** <font color = ' #7d8793'>List</font>
  ...
  - **sharingIdentityType**   <font color = ' #7d8793'>String</font>    <font color = '#f19938'>Required</font>
    ...
    `BOTIM_ID`. Transfer through BOTIM user ID.
  ...
  - **withholdAndRemitFee** <font color = ' #7d8793'>Boolean</font>
     ...
     Indicates whether the transaction fee is withheld and remitted on behalf of the split party. It may appear at most once across all split entries, or not at all. If omitted, it is assumed that no fee withholding policy is applied by default.
...
- **reason** <font color = ' #7d8793'>String</font>
  ...
  The reason to refund the payment order.
...
- **deviceId** <font color = ' #7d8793'>String</font>
  ...
  Note that this parameter must be passed if you are using the secondary merchant function, this parameter must be passed.
