...
| Signature        | Sign             | Required | String      | -                | Digital signature for request verification |
| Partner ID       | Partner-Id       | Required | String(12)  | -                | Merchant identifier                        |
| Content Type     | Content-Type     | Required | String(256) | application/json | MIME type of the response content          |

#### HTTP Body

| Field Name      | Variable Name | Required | Type           | Example | Description                                    |
| --------------- | ------------- | -------- | -------------- | ------------- | ---------------------------------------------- |
| Response Header | head          | Required | ResponseHeader | -             | Contains response status and error information |
...
| Field Name          | Variable Name       | Required | Type   | Example                       | Description                          |
| ------------------- | ------------------- | -------- | ------ | ------------------------------------------------------------ | ------------------------------------ |
| Content Disposition | Content-Disposition | Required | String | attachment; filename=200000054800_20210112Transaction_Settle_Statement.zip | File attachment information          |
| Content Type        | Content-Type        | Required | String | application/zip                                              | MIME type indicating ZIP file format |
