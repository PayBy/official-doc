...
- **Holder Name**  
    - **Parameter Name**: `holderName`  
    - **Required**: Yes  
    - **Type**: `String(256)`  
    - **Example**: *(none provided)*  
    - **Description**: Encrypted account holder name.
...
- **IBAN**  
    ...
    - **Type**: `String(256)`  
    - **Example**: *(none provided)*  
    - **Description**: Encrypted IBAN number.
...
- **Response Body**  
    - **Parameter Name**: `body`  
    - **Required**: No  
    - **Type**: `GetIbanHolderNameResponse`  
        - **IBAN Info**  
            - **Parameter Name**: `ibanHolderName`  
            - **Required**: Yes  
            - **Type**: `IbanHolderName`  
            - **Example**: *(none provided)*  
            - **Description**: Contains the name match result.
            - **Example**: *(none provided)*  
            - **Description**: Core response payload.
