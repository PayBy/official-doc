...
- **Content (`Content-Language`)**  
  &lt;font color='#7d8793'&gt;String(10)&lt;/font&gt; &lt;font color='#f19938'&gt;Optional&lt;/font&gt;  
  - The language of the content.  
  - Example value: `en`  
  - Description: `en` = English  

- **Signature (`Sign`)**  
  &lt;font color='#7d8793'&gt;String&lt;/font&gt; &lt;font color='#f19938'&gt;Mandatory&lt;/font&gt;  
...
- **Merchant ID (`Partner-Id`)**  
  &lt;font color='#7d8793'&gt;String(12)&lt;/font&gt; &lt;font color='#f19938'&gt;Mandatory&lt;/font&gt;  
