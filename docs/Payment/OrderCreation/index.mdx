...
import CashTopUp from "./_cashtopup.md";
import PAYANDSIGN from './_payandsign.md';
...
- **promotionInfoList** <span style={{color:" #7d8793"}}>List</span>
  ...
  The attributes in the list are:
    ...
    - **appliedRewardId**   <font color = ' #7d8793'>String</font>    <font color = '#f19938'>Required</font>
...
| 500   | SYSTEM_ERROR                                 | System error                                                 | Contact PayBy<br>Retry later               |
