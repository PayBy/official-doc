...
- **sharingInfoList** <span style={{color:" #7d8793"}}>List</span> 
  ...
  - **sharingSettledAmount**   <font color = ' #7d8793'>Money</font>    <font color = '#f19938'>Required</font>
    ...
    The amount this id actually received. If the order is not settled in real-time and a refund occurs before settlement, the requested amount will be different from the actual amount.
