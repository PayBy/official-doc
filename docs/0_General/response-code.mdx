...
| 62043 | MISSING_BUSINESS_TYPE          | Missing businessType. Please adjust the request parameters.     |
| 62044 | INVALID_BUSINESS_TYPE          | The businessType is invalid. Please adjust the request parameters.     |
| 62085 | MISSING_PROTOCOL_SCENE_CODE       | Missing protocol scene code. Please adjust the request parameters. |
...
| 62086 | INVALID_PAYEEMID                  | The PayeeMid is invalid. Please check and adjust the request parameters |
| 62087 | INVALID_TYPE                      | The type is invalid. Please check and adjust the request parameters |
| 62088 | MISSING_UNIQUE_ID                 | Missing uniqueId, please check and adjust the request parameters |
| 62089 | INVALID_EXPIRED_TIME              | The expiredTime is invalid, please check and adjust the request parameterss |
...
| 62007 | REFUND_MERCHANT_ORDER_NO_NOT_EXIST         | The refund merchant order number does not exist. Please check and update the request parameters  |
...
| 62030 | ORDER_BANK_FAIL                | The order has been refunded, please adjust the merchant order number |
...
| 62084 | REFUND_SHARING_MEMBER_MISMATCH | The refund sharing details on member ID do not match. Please review and update your request parameters. |
...
| Code  | Message                     | Description                                                  |
| ----- | --------------------------- | ------------------------------------------------------------ |
| 62083 | SHARING_MEMBER_NOT_EXIST | The sharing member ID do not exist. Please review and update your request parameters. |
...
| 62014 | STATEMENT_NOT_GENERATED | Statement not generated. Please download the statement after the specified time set by the merchant. | 
